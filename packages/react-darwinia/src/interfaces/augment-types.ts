...
import { ActiveEraInfo, CompactAssignments, CompactScore, ElectionCompute, ElectionResult, ElectionStatus, EraIndex, EraPoints, EraRewardPoints, EraRewards, Forcing, IndividualExposure, KeyType, MomentOf, Nominations, NominatorIndex, OffchainAccuracy, PerU16, PhragmenScore, Points, ReleasesStaking, RewardDestination, RewardPoint, SlashJournalEntry, SlashingSpans, SlashingSpansTo204, SpanIndex, SpanRecord, StakingLedgerTo223, StakingLedgerTo240, UnappliedSlash, UnappliedSlashOther, UnlockChunk, ValidatorIndex, ValidatorPrefs, ValidatorPrefsTo145, ValidatorPrefsTo196 } from '@polkadot/types/interfaces/staking';
...
import { AddressT, BalanceInfo, Bloom, Common, DepositId, DoubleNodeWithMerkleProof, ElectionResultT, EthAddress, EthBlockNumber, EthHeader, EthHeaderBrief, EthNetworkType, EthReceiptProof, EthTransactionIndex, Exposure, ExposureT, H128, KtonBalance, LockFor, LockReasons, LogEntry, MerkleMountainRangeRootLog, OtherAddress, OtherSignature, Power, RKT, Receipt, RedeemFor, RingBalance, Staked, StakingBalanceT, StakingLedgerT, StakingLedger, StakingLock, TimeDepositItem, TransactionOutcome, TronAddress, TsInMs, Unbonding } from '@polkadot/react-darwinia/interfaces/darwiniaInject';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<LockReasons>': Option<LockReasons>;
    'Vec<LockReasons>': Vec<LockReasons>;
    Unbonding: Unbonding;
    ...
    'Vec<RKT>': Vec<RKT>;
    EthTransactionIndex: EthTransactionIndex;
    'Option<EthTransactionIndex>': Option<EthTransactionIndex>;
    'Vec<EthTransactionIndex>': Vec<EthTransactionIndex>;
    EthHeaderBrief: EthHeaderBrief;
    'Option<EthHeaderBrief>': Option<EthHeaderBrief>;
    'Vec<EthHeaderBrief>': Vec<EthHeaderBrief>;
    EthBlockNumber: EthBlockNumber;
    'Compact<EthBlockNumber>': Compact<EthBlockNumber>;
    'Option<EthBlockNumber>': Option<EthBlockNumber>;
    'Vec<EthBlockNumber>': Vec<EthBlockNumber>;
    EthHeader: EthHeader;
    ...
    'Vec<H128>': Vec<H128>;
    DoubleNodeWithMerkleProof: DoubleNodeWithMerkleProof;
    'Option<DoubleNodeWithMerkleProof>': Option<DoubleNodeWithMerkleProof>;
    'Vec<DoubleNodeWithMerkleProof>': Vec<DoubleNodeWithMerkleProof>;
    ...
    'Option<EthNetworkType>': Option<EthNetworkType>;
    'Vec<EthNetworkType>': Vec<EthNetworkType>;
    RedeemFor: RedeemFor;
