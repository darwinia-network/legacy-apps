...
import { EthHeader, EthReceiptProof, KtonBalance, MomentT, RewardDestination, RingBalance, StakingBalanceT } from '../types';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    ethBacking: {
      ...
      redeemRing: AugmentedSubmittable<(proofRecord: EthReceiptProof | { index?: any; proof?: any; header_hash?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      redeemKton: AugmentedSubmittable<(proofRecord: EthReceiptProof | { index?: any; proof?: any; header_hash?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      redeemDeposit: AugmentedSubmittable<(proofRecord: EthReceiptProof | { index?: any; proof?: any; header_hash?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    ethRelay: {

      resetGenesisHeader: AugmentedSubmittable<(header: EthHeader | { parent_hash?: any; timestamp?: any; number?: any; auth?: any; transaction_root?: any; uncles_hash?: any; extra_data?: any; state_root?: any; receipts_root?: any; log_bloom?: any; gas_used?: any; gas_limit?: any; difficulty?: any; seal?: any; hash?: any } | string | Uint8Array, genesisDifficulty: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      relayHeader: AugmentedSubmittable<(header: EthHeader | { parent_hash?: any; timestamp?: any; number?: any; auth?: any; transaction_root?: any; uncles_hash?: any; extra_data?: any; state_root?: any; receipts_root?: any; log_bloom?: any; gas_used?: any; gas_limit?: any; difficulty?: any; seal?: any; hash?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    ...
    staking: {
       ...
       * # </weight>
       **/
      bond: AugmentedSubmittable<(controller: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, value: StakingBalanceT | { all: any } | { ringBalance: any } | { ktonBalance: any } | string | Uint8Array, payee: RewardDestination | { staked: any } | { stash: any } | { controller: any } | string | Uint8Array, promiseMonth: Moment | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * # </weight>
       **/
      bondExtra: AugmentedSubmittable<(maxAdditional: StakingBalanceT | { all: any } | { ringBalance: any } | { ktonBalance: any } | string | Uint8Array, promiseMonth: Moment | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      depositExtra: AugmentedSubmittable<(value: RingBalance | AnyNumber | Uint8Array, promiseMonth: Moment | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * </weight>
       **/
      unbond: AugmentedSubmittable<(value: StakingBalanceT | { all: any } | { ringBalance: any } | { ktonBalance: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      claimMatureDeposits: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>>;
      tryClaimDepositsWithPunish: AugmentedSubmittable<(expireTime: MomentT | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
    ...
    treasury: {
       ...
       * # </weight>
       **/
      proposeSpend: AugmentedSubmittable<(ringValue: Compact<RingBalance> | AnyNumber | Uint8Array, ktonValue: Compact<KtonBalance> | AnyNumber | Uint8Array, beneficiary: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
