...
import { BalanceLockTo212, Reasons, VestingSchedule, WithdrawReasons } from '@polkadot/types/interfaces/balances';
...
import { CompactAssignments, CompactScore, ElectionCompute, ElectionResult, ElectionStatus, EraIndex, EraPoints, EraRewardPoints, EraRewards, Forcing, KeyType, MomentOf, Nominations, PhragmenScore, Points, RewardPoint, SlashJournalEntry, SlashingSpans, SlashingSpansTo204, SpanIndex, SpanRecord, StakingLedgerNew, StakingLedgerTo223, UnappliedSlash, UnappliedSlashOther, UnlockChunk, ValidatorIndex, ValidatorPrefs, ValidatorPrefsTo145, ValidatorPrefsTo196 } from '@polkadot/types/interfaces/staking';
...
import { AccountData, AddressT, BalanceLock, Bloom, Common, DepositId, EthAddress, EthBlockNumber, EthHeader, EthReceiptProof, EthTransactionIndex, Exposure, HeaderInfo, IndividualExposure, KtonBalance, LockFor, LockReasons, MomentT, NominatorReward, Power, RK, RKT, Receipt, RewardDestination, RingBalance, Staked, StakingBalance, StakingBalanceT, StakingLedger, StakingLedgerT, StakingLock, TimeDepositItem, TronAddress, Unbonding, ValidatorReward } from '../types';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    MomentT: MomentT;
    'Option<MomentT>': Option<MomentT>;
    'Vec<MomentT>': Vec<MomentT>;
    Power: Power;
    ...
    'Option<StakingBalance>': Option<StakingBalance>;
    'Vec<StakingBalance>': Vec<StakingBalance>;
    ...
    'Option<ValidatorReward>': Option<ValidatorReward>;
    'Vec<ValidatorReward>': Vec<ValidatorReward>;
    NominatorReward: NominatorReward;
    'Option<NominatorReward>': Option<NominatorReward>;
    'Vec<NominatorReward>': Vec<NominatorReward>;
    RKT: RKT;
    ...
    'Option<HeaderInfo>': Option<HeaderInfo>;
    'Vec<HeaderInfo>': Vec<HeaderInfo>;
    EthHeader: EthHeader;
